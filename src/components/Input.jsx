  ...
  return (
    <div className="mb-4">
      ...
      <div className="relative">
        {isSelect ? (
          <select className="w-full bg-transparent outline-none border border-gray-300 rounded-md p-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-blue-400" value={value} onChange={(e)=>onChange(e)}>
